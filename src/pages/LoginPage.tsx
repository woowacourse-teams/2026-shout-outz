...
export function LoginPage({ isConfigured, isLoading, error, returnTo = '/submit', onLogin }: LoginPageProps) {
  return (
    <div className="login-page page-pad">
      <div className="content-container">
        <Link to="/" className="back-link"><ArrowLeft size={15} /> 홈으로</Link>
        <section className="login-card" aria-labelledby="login-title">
          <h1 id="login-title">로그인이 필요한<br /><em>서비스입니다.</em></h1>
          <p>로그인하면 서비스를 저장하고, 좋아요를 누르고, 내 서비스를 관리할 수 있습니다.</p>
