      ...
      <div className="content-container privacy-page__container">
        ...
        <article className="privacy-document">
          ...
          <section>
            ...
            <p>이메일 주소와 이름을 {serviceNames}로 전송하지 않습니다.{services.some(({ id }) => id === 'google-analytics') ? ' 다만 내부 식별자도 이용자를 구분하는 정보이므로 이 안내에 포함해 공개합니다.' : ''}</p>
          </section>

          <section>
            <h2>3. 이용자의 선택</h2>
            <p>분석 동의 후에만 {serviceNames}를 초기화하고 측정 데이터를 전송합니다. 거부한 경우 구성된 분석 서비스를 실행하지 않습니다. 하단의 분석 설정에서 언제든 선택을 다시 변경할 수 있습니다.</p>
