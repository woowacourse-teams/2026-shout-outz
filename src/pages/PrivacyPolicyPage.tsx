      ...
      <div className="content-container privacy-page__container">
        ...
        <article className="privacy-document">
          <div className="privacy-document__intro">
            <ShieldCheck size={20} />
            <p>이 페이지는 현재 Dropit에서 사용하는 Google Analytics 4(GA4)와 Microsoft Clarity의 수집·이용 내용을 안내합니다.</p>
          </div>
          <p className="privacy-document__updated">시행일: 2026년 7월 25일</p>

          <section>
            <h2>1. 수집 목적</h2>
            <p>Dropit은 방문 규모와 기능 이용 흐름을 파악하고 서비스의 안정성과 사용성을 개선하기 위해 GA4를 사용합니다. 또한 화면 조작 흐름을 이해하고 UI 개선점을 찾기 위해 Microsoft Clarity로 세션 리플레이와 히트맵을 수집합니다.</p>
          </section>
          ...
          <section>
            ...
            <ul>
              ...
              <li>마우스 이동·클릭·스크롤 등 화면 조작 기록(세션 리플레이) 및 클릭 히트맵</li>
            </ul>
            <p>이메일 주소와 이름을 Google Analytics 또는 Microsoft Clarity로 전송하지 않습니다. 다만 내부 식별자도 이용자를 구분하는 정보이므로 이 안내에 포함해 공개합니다.</p>
          </section>

          <section>
            <h2>3. 이용자의 선택</h2>
            <p>분석 동의 후에만 GA4와 Microsoft Clarity를 초기화하고 측정 데이터를 전송합니다. 거부한 경우 두 서비스 모두 실행하지 않습니다. 하단의 분석 설정에서 언제든 선택을 다시 변경할 수 있습니다.</p>
          ...
          <section>
            ...
            <p>Microsoft Clarity는 Microsoft Corporation이 제공하는 세션 리플레이·히트맵 분석 서비스입니다. Microsoft의 데이터 처리 방식은 Microsoft의 개인정보처리방침에서 확인할 수 있습니다.</p>
            <a className="privacy-document__external-link" href="https://privacy.microsoft.com/ko-kr/privacystatement" target="_blank" rel="noreferrer">Microsoft 개인정보처리방침 <ExternalLink size={14} /></a>
          </section>
