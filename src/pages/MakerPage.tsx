      ...
      <div className="content-container">
        ...
        <div className="profile-setup__card">
          ...
          <form className="profile-form" onSubmit={handleSubmit} noValidate>
            <div className="form-field"><div className="form-field__label"><label htmlFor="profile-name">이름<span aria-hidden="true">*</span></label><span>최대 20자</span></div><input id="profile-name" value={name} maxLength={20} onChange={(event) => { setName(event.target.value); setError('') }} placeholder="예: 홍길동" /></div>
            <div className="form-field"><div className="form-field__label"><label htmlFor="profile-role">역할 또는 소속<span aria-hidden="true">*</span></label><span>최대 40자</span></div><input id="profile-role" value={role} maxLength={40} onChange={(event) => { setRole(event.target.value); setError('') }} placeholder="예: 우테코 7기 · 백엔드" /></div>
            <div className="form-field"><div className="form-field__label"><label htmlFor="profile-bio">짧은 소개<span aria-hidden="true">*</span></label><span>최대 100자</span></div><textarea id="profile-bio" value={bio} maxLength={100} onChange={(event) => { setBio(event.target.value); setError('') }} placeholder="만든 앱을 소개하세요." rows={4} /></div>
