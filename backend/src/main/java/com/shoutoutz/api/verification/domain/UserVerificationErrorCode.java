...
public enum UserVerificationErrorCode implements ErrorCode {
    ...
    VERIFICATION_REQUEST_NOT_FOUND("크루/코치 인증 신청을 찾을 수 없습니다."),
    VERIFICATION_REQUEST_NOT_PENDING("대기 중인 인증 신청만 처리할 수 있습니다."),
    ...
    VERIFICATION_ADMIN_FORBIDDEN("관리자만 크루/코치 인증 신청을 관리할 수 있습니다."),
