...
class ProjectCommentUpdateRequestTest {
    ...
    void stripsContent() {
        ProjectCommentUpdateRequest request = new ProjectCommentUpdateRequest("  수정된 댓글\n");
    ...
    void acceptsContentUpTo500CodePoints() {
        ProjectCommentUpdateRequest request = new ProjectCommentUpdateRequest("😀".repeat(500));
    ...
    void rejectsContentOver500CodePoints() {
        ProjectCommentUpdateRequest request = new ProjectCommentUpdateRequest("😀".repeat(501));
    ...
    void rejectsBlankContent() {
        ProjectCommentUpdateRequest request = new ProjectCommentUpdateRequest(" \n\t ");
