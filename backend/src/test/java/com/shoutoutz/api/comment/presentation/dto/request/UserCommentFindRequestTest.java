...
class UserCommentFindRequestTest {
    ...
    void 조회_개수는_1_이상_50_이하로_입력할_수_있다(int size) {
        UserCommentFindRequest request = new UserCommentFindRequest(null, size);
    ...
    void 공백뿐인_커서는_첫_페이지로_본다() {
        UserCommentFindRequest request = new UserCommentFindRequest(" ", null);
